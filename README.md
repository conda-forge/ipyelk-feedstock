...
Once the `conda-forge` channel has been enabled, `ipyelk` can be installed with:

```
conda install ipyelk
```

It is possible to list all of the versions of `ipyelk` available on your platform with:
